...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
  ...
  #  result.geometry('700x550')
    ...
    result.configure(background='white')#here
...
def perdict_person():
    ...
    lab=Label(top, text="Personality Prediction", foreground='#3b3b3b', bg='#d9e6ff', font=titleFont, pady=10).pack()
    ...
    l1=Label(top, text="Applicant Name", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=130)
    l2=Label(top, text="Age", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=160)
    l3=Label(top, text="Gender", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=190)
    l4=Label(top, text="Upload Resume", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=220)
    l5=Label(top, text="Enjoy new experiences or thing(Openness):", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=250)
    l6=Label(top, text="How often you feel negativity(Neuroticism):", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=280)
    l7=Label(top, text="Wishing to do one's work well and thoroughly(Conscientiousness):", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=310)
    l8=Label(top, text="How much would you like to work with your peers(Agreeableness):", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=340)
    l9=Label(top, text="How outgoing and social interactive are you (Extraversion):", foreground='#3b3b3b', bg='#d9e6ff').place(x=70, y=370)
